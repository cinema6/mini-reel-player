...
describe('rumble', function() {
    ...
    it('should exist', function() {
        expect(rumble).toEqual(jasmine.any(Object));
    });
    ...
    describe('properties', function() {
        describe('Player($iframe)', function() {
            it('should add itself to the players hash', function() {
                let player = new rumble.Player(new IFrame('//rumble.com/embed/27855315/?api=1&player_id=rc-1&foo=bar'));

                expect(rumble.players['rc-1']).toBe(player);
            });

            it('should throw an error if the iframe provided has no player_id', function() {
                expect(function() {
                    new rumble.Player(new IFrame('//rumble.com/embed/27855315/?api=1'));
            ...
            describe('event handling', function() {
                ...
                beforeEach(function() {
                    player = new rumble.Player(new IFrame('//rumble.com/embed/27855315/?api=1&player_id=rc-2'));
            ...
            describe('properties:', function() {
                ...
                beforeEach(function() {
                    player = new rumble.Player(new IFrame('//rumble.com/embed/27855315/?api=1&player_id=rc-7'));
                });
            ...
            describe('methods:', function() {
                ...
                beforeEach(function() {
                    player = new rumble.Player(new IFrame('//rumble.com/embed/27855315/?api=1&player_id=rc-1'));
                });
                ...
                describe('destroy()', function() {
                    ...
                    it('should remove the player from the service\'s players object', function() {
                        expect(rumble.players['rc-1']).not.toBeDefined();
                    });
                });
                ...
                describe('call(method, data)', function() {
                    ...
                    describe('if the iframe has been destroyed', function() {
                        ...
                        it('should reject with an error', function() {
                            expect(failure).toHaveBeenCalledWith(new Error(`Cannot call pause() on RumblePlayer [${player.id}] because it is destroyed.`));
                        });
                    });
