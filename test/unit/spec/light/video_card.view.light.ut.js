...
describe('LightVideoCardView', function() {
    ...
    describe('properties:', function() {
        describe('template', function() {
            it('should be the contents of LightVideoCardView.html', function() {
                expect(view.template).toBe(require('../../../../src/views/light/LightVideoCardView.html'));
            });
        });
