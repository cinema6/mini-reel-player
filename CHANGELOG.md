...
* *[v2.6.5-rc1]*
  * [FIX]: Ballot choice buttons have the right colors on hover, share modal optimized for smallest ad unit sizes
  * [FEATURE]: Desktop-card redesigned to support Domino
