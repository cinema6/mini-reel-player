...
class View extends Mixable {
    constructor(element) {
        ...
        _(this).parent = null;
        _(this).handleParentDestroyed = (() => this.parent = null);
        _(this).handleParentInserted = (() => this.didInsertElement());
        _(this).handleParentRemoved = (() => this.willRemoveElement());
    ...
    /**
     * A reference to the view this view was inserted into.
     *
     * @property parent
     * @type View
     * @final
    ...
    set parent(view) {
        const {
            ...
            handleParentInserted,
            handleParentRemoved
        } = _(this);

        if (parent) {
            parent.removeListener('destroyed', handleParentDestroyed);
            parent.removeListener('inserted', handleParentInserted);
            parent.removeListener('removed', handleParentRemoved);
        }

        _(this).parent = view;

        if (view) {
            view.once('destroyed', handleParentDestroyed);
            view.on('inserted', handleParentInserted);
            view.on('removed', handleParentRemoved);
        }
    }
    ...
    appendTo(parent) {
        ...
        Runner.schedule('render', null, () => {
            ...
            if (!this.inserted && parent.inserted) {
                this.didInsertElement();
            }
        });
    }
    ...
    /**
     * Fired when the View's element is created.
     *
     * @event created
     */
    didCreateElement() {
