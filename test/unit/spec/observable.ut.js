...
describe('Observable', function() {
    ...
    describe('setting properties', function() {
        ...
        it('should be able to emit becameTrue events', function() {
            observable.set('prop1', true);
            expect(observable.emit).toHaveBeenCalledWith('change:prop1', true);
            expect(observable.emit).toHaveBeenCalledWith('becameTrue:prop1', true);
        });
        
        it('should be able to emit becameFalse events', function() {
            observable.set('prop1', false);
            expect(observable.emit).toHaveBeenCalledWith('change:prop1', false);
            expect(observable.emit).toHaveBeenCalledWith('becameFalse:prop1', false);
        });
    });
